...
int bitXor(int x, int y) {
  int notX = ~x;
  int notY = ~y;
  int x_and_not_y = x & notY;
  int not_x_and_y = notX & y;
  int not_xAndNotY = ~(x_and_not_y);
  int not_notXandY = ~(not_x_and_y);
  // AND the two last statements
  int and = not_xAndNotY & not_notXandY;
  // Negate it and this is the answer.
  int neg = ~and;
  return neg;
}
/*
